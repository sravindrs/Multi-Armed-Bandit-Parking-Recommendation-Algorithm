...
payouts[0] = data['Rams 8-9']
payouts[1] = data['Morehead 8-9']
payouts[2] = data['Raleigh Road Lot 8-9']
payouts[3] = data['Raleigh Rd 8-9']
payouts[4] = data['Country Club 8-9']
payouts[5] = data['Raleigh St 8-9']
payouts[6] = data['Wilson 8-9']
payouts[7] = data['UL 8-9']
payouts[8] = data['FedEx 8-9']
payouts[9] = data['Davis 8-9']

labels = ['Rams 8-9', 'Morehead 8-9', 'Raleigh Road Lot 8-9', 'Raleigh Rd 8-9', 'Country Club 8-9', 'Raleigh St 8-9', 'Wilson 8-9', 'UL 8-9', 'FedEx 8-9', 'Davis 8-9']
