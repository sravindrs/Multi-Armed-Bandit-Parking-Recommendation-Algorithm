...
payouts[0] = data['Rams 3-4']
payouts[1] = data['Morehead 3-4']
payouts[2] = data['Raleigh Road Lot 3-4']
payouts[3] = data['Raleigh Rd 3-4']
payouts[4] = data['Country Club 3-4']
payouts[5] = data['Raleigh St 3-4']
payouts[6] = data['Wilson 3-4']
payouts[7] = data['UL 3-4']
payouts[8] = data['FedEx 3-4']
payouts[9] = data['Davis 3-4']

labels = ['Rams 3-4', 'Morehead 3-4', 'Raleigh Road Lot 3-4', 'Raleigh Rd 3-4', 'Country Club 3-4', 'Raleigh St 3-4', 'Wilson 3-4', 'UL 3-4', 'FedEx 3-4', 'Davis 3-4']
