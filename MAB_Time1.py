...
payouts[0] = data['Rams 7-8']
payouts[1] = data['Morehead 7-8']
payouts[2] = data['Raleigh Road Lot 7-8']
payouts[3] = data['Raleigh Rd 7-8']
payouts[4] = data['Country Club 7-8']
payouts[5] = data['Raleigh St 7-8']
payouts[6] = data['Wilson 7-8']
payouts[7] = data['UL 7-8']
payouts[8] = data['FedEx 7-8']
payouts[9] = data['Davis 7-8']

labels = ['Rams 7-8', 'Morehead 7-8', 'Raleigh Road Lot 7-8', 'Raleigh Rd 7-8', 'Country Club 7-8', 'Raleigh St 7-8', 'Wilson 7-8', 'UL 7-8', 'FedEx 7-8', 'Davis 7-8']
