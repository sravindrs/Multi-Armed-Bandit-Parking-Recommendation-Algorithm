...
payouts[0] = data['Rams 1-2']
payouts[1] = data['Morehead 1-2']
payouts[2] = data['Raleigh Road Lot 1-2']
payouts[3] = data['Raleigh Rd 1-2']
payouts[4] = data['Country Club 1-2']
payouts[5] = data['Raleigh St 1-2']
payouts[6] = data['Wilson 1-2']
payouts[7] = data['UL 1-2']
payouts[8] = data['FedEx 1-2']
payouts[9] = data['Davis 1-2']

labels = ['Rams 1-2', 'Morehead 1-2', 'Raleigh Road Lot 1-2', 'Raleigh Rd 1-2', 'Country Club 1-2', 'Raleigh St 1-2', 'Wilson 1-2', 'UL 1-2', 'FedEx 1-2', 'Davis 1-2']
