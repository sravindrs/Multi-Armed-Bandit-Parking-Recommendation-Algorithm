...
payouts[0] = data['Rams 12-1']
payouts[1] = data['Morehead 12-1']
payouts[2] = data['Raleigh Road Lot 12-1']
payouts[3] = data['Raleigh Rd 12-1']
payouts[4] = data['Country Club 12-1']
payouts[5] = data['Raleigh St 12-1']
payouts[6] = data['Wilson 12-1']
payouts[7] = data['UL 12-1']
payouts[8] = data['FedEx 12-1']
payouts[9] = data['Davis 12-1']

labels = ['Rams 12-1', 'Morehead 12-1', 'Raleigh Road Lot 12-1', 'Raleigh Rd 12-1', 'Country Club 12-1', 'Raleigh St 12-1', 'Wilson 12-1', 'UL 12-1', 'FedEx 12-1', 'Davis 12-1']
