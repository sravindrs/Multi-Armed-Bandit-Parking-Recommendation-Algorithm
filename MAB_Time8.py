...
payouts[0] = data['Rams 2-3']
payouts[1] = data['Morehead 2-3']
payouts[2] = data['Raleigh Road Lot 2-3']
payouts[3] = data['Raleigh Rd 2-3']
payouts[4] = data['Country Club 2-3']
payouts[5] = data['Raleigh St 2-3']
payouts[6] = data['Wilson 2-3']
payouts[7] = data['UL 2-3']
payouts[8] = data['FedEx 2-3']
payouts[9] = data['Davis 2-3']

labels = ['Rams 2-3', 'Morehead 2-3', 'Raleigh Road Lot 2-3', 'Raleigh Rd 2-3', 'Country Club 2-3', 'Raleigh St 2-3', 'Wilson 2-3', 'UL 2-3', 'FedEx 2-3', 'Davis 2-3']
